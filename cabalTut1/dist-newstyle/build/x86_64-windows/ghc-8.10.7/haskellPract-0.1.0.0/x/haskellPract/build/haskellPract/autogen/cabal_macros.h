...
/* package haskellPract-0.1.0.0 */
#ifndef VERSION_haskellPract
#define VERSION_haskellPract "0.1.0.0"
#endif /* VERSION_haskellPract */
#ifndef MIN_VERSION_haskellPract
#define MIN_VERSION_haskellPract(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskellPract */
...
#define CURRENT_COMPONENT_ID "haskellPract-0.1.0.0-inplace-haskellPract"
